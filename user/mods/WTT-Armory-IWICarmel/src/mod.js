...
class WTTArmoryIWICarmel {
    ...
    displayCreditBanner() {
        ...
        this.Instance.logger.log(`[${this.modName}] Developers:Tron, Civok, and the WTT Team`, LogTextColor_1.LogTextColor.GREEN);
        this.Instance.logger.log(`[${this.modName}] IWI go brrrrrr`, LogTextColor_1.LogTextColor.GREEN);
        this.Instance.logger.log(`[${this.modName}] ------------------------------------------------------------------------`, LogTextColor_1.LogTextColor.GREEN);
    }
}
module.exports = { mod: new WTTArmoryIWICarmel() };
